    ...
    >
      <div v-if="showMenu" class="absolute bottom-16 right-0 flex flex-col gap-3 items-end mb-2">
        <button
          ...
          class="flex items-center gap-3 pr-4 pl-3 py-2 bg-white rounded-full shadow-lg hover:shadow-xl transition-shadow"
        >
          <div :class="[item.color, 'w-8 h-8 rounded-full flex items-center justify-center']">
